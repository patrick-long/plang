...
test("functionCalls.txt test file should be read and used as input to create a new program", () => {
	let result;
	const parser = new Parser();
	const environment = new Environment();

	const filePath = path.resolve(__dirname, "fixtures/functionCalls.txt");
